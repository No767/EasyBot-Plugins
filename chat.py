...
class Chat(commands.Cog):
    ...
    async def chathelp(self, ctx):
        await ctx.send("The chat is automatically generated based on prewritten responses. Responses that are not documented will be ignored")
                ...
                try:
                    ...
                    for i in msg_responses:
                        if i['ping'] == msg:
                            ...
                            return
                    await message.channel.send(f'Sorry, a response to *"{msg}"* has not yet been added.')
                except Exception as e:
